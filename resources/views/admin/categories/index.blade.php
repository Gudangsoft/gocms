...
<div class="sm:flex sm:items-center">
    <div class="sm:flex-auto">
        <p class="text-sm text-gray-700">Organize your articles with categories across all your websites.</p>
    </div>
                ...
                <table class="min-w-full divide-y divide-gray-300">
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        ...
                        <tr class="hover:bg-gray-50">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div class="text-sm text-gray-900">{{ $category->site->name }}</div>
                                <div class="text-sm text-gray-500">{{ $category->site->domain }}</div>
                            </td>
