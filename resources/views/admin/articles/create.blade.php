                ...
                <div class="bg-white shadow sm:rounded-lg">
                    <div class="px-4 py-5 sm:p-6">
                        ...
                        <div class="mb-6">
                            ...
                            <p class="mt-1 text-sm text-gray-500">Optional brief description for SEO and previews</p>
                            @error('excerpt')
                                <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
                ...
                <div class="bg-white shadow sm:rounded-lg">
                    <div class="px-4 py-5 sm:p-6">
                        ...
                        <div class="mb-4">
                            ...
                            <select name="site_id" id="site_id" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm @error('site_id') border-red-300 @enderror" required>
                        ...
                        <div class="mb-4">
                            ...
                            <select name="category_id" id="category_id" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm @error('category_id') border-red-300 @enderror" required>
                        ...
                        <div class="mb-4">
                            ...
                            <p class="mt-1 text-sm text-gray-500">Featured articles appear prominently on the site</p>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="px-4 py-5 sm:p-6">
                        ...
                        <div class="mb-4">
                            <div class="flex space-x-4 mb-4">
                                <button type="button" id="upload-tab" class="px-4 py-2 text-sm font-medium text-blue-600 bg-blue-50 rounded-md hover:bg-blue-100">
                                    Upload File
                                </button>
                                <button type="button" id="url-tab" class="px-4 py-2 text-sm font-medium text-gray-500 bg-gray-50 rounded-md hover:bg-gray-100">
                                    Use URL
                                </button>
                            </div>
                        </div>
...
uploadTab.addEventListener('click', function() {
    uploadTab.classList.add('text-blue-600', 'bg-blue-50');
    uploadTab.classList.remove('text-gray-500', 'bg-gray-50');
    urlTab.classList.remove('text-blue-600', 'bg-blue-50');
    urlTab.classList.add('text-gray-500', 'bg-gray-50');
...
urlTab.addEventListener('click', function() {
    urlTab.classList.add('text-blue-600', 'bg-blue-50');
    urlTab.classList.remove('text-gray-500', 'bg-gray-50');
    uploadTab.classList.remove('text-blue-600', 'bg-blue-50');
    uploadTab.classList.add('text-gray-500', 'bg-gray-50');
...
fileInput.addEventListener('change', function(e) {
    ...
    if (file) {
        ...
        reader.onload = function(e) {
            ...
            hiddenInput.value = 'file-uploaded';
        };
